...
SECRET_KEY = 'django-insecure-0d9vhn%8!fu538tdu85c2(=$g4$cl4fg^hscl3nkw1o2m9x9&i'
...
REST_FRAMEWORK = {
    ...
    # Removed global DEFAULT_AUTHENTICATION_CLASSES to allow AllowAny views without auth
    # Add authentication_classes explicitly in views that require it
...
JAZZMIN_SETTINGS = {
    "site_title": "BigBasket Admin",
    "site_header": "BigBasket",
    "site_brand": "You order,we deliver",
    "welcome_sign": "Welcome to BigBasket Admin",
